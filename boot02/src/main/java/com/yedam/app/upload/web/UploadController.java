...
//====================================
	...
	public String formUploadFile(@RequestPart MultipartFile[] images) {
		...
		for(MultipartFile image : images) {			
			log.info(image.getContentType());		  // 개별파일의 종류
			log.info(image.getOriginalFilename());    // 사용자가 넘겨준 실제 파일이름 
			log.info(String.valueOf(image.getSize()));// 파일사이즈
...
//==================================
	...
	private String makeFolder() {
		...
		if (uploadPathFoler.exists() == false) { //exists 존재한다-> 건너뜀, 존재X -> 폴더만듦. 
